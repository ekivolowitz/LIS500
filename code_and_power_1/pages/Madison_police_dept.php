  ...
  <div class="row content" style="height: 0px;">
    ...
    <h1>Government Website: Madison Police Department (MPD)</h1>
      ...
      <p>This website is well designed to be accessable from all devices: Mac/PC and IOS/Adroid.
        ...
        who don't have regular access to a computer, and can't just try again later, and an accessability issue
        for people who rely on the department's online form submission options for things like accident reporting.
      ...
      <p>There are links to a lot of resources on this site. Much thought went into catagorizing 
        and making the content on the site, and MPD in general, as accessable as possible to the public. 
        There is so much information that finding what you are specifically looking for could be problematic, 
        especially for someone who is unfamiliar with searching. However, the most important contact info is featured prominantly
        on the homepage, making it easy for a user to call and get further, non-internet dependent help. MPD also has a presence
        on many social media platforms, although we didn't specifically look into how that presence is being managed. The glaring 
      ...
      <p>The MPD website is designed to be a civic resource for the general public in the city of Madison, and the site, except for the 
        above mentioned lack of language accessabiltiy does appear to be doing a decent job in providing access to public forms,
        general safety information, and other important public information. The MPD is using the site to post demographic information
