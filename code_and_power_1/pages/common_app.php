    ...
    <div class="col-sm-8 text-left"> 
     ...
     <div><img src="../images/mainpage.png"></div>
      ...
      <p>
          ...
          practical. This is because there are a number of resources to review and download. To only use a mobile device
          would become extremely cumbersome. Even though desktop is ideal, mobile version is well adapted for viewing on
      ...
      <p>
        Overall, the website for the Common Application is fairly accessible. The layout is clean and tabs are
          appropriately labeled. The site goes beyond just applying for college as well. There are resources for
          figuring out how to pay for college, exploring colleges, and why even go to college. It is the ultimate guide
          for the student thinking - "I'm graduating high school, and am considering college. Now what?".
